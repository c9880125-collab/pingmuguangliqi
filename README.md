...
- 升档时按设备支持的模式逐级切换
- 降档时严格按刷新率逆序逐级切换
- 严格逐档确认：每一档必须被活动显示模式连续确认后才进入下一档
- 单档失败自动重试；仍失败则停止并按已确认路径回退
- 所有切换全局串行，新请求会取消旧请求，避免手动与逐应用切换互相覆盖
...
- 源代码：<https://github.com/c9880125-collab/pingmuguangliqi>
- 问题反馈：<https://www.coolapk.com/u/34485927>
